...
const FALLBACK_REPORT: EvaluationReport = {
  overallScore: 72,
  dimensionScores: {
    zero_to_launch: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    solution_architecture_fluency: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    structured_discovery: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    client_engagement_ownership: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    commercial_discipline: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    ai_native_operating_model: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    t_shaped_range: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    project_order_knowledge_discipline: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    pyramid_communication: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
    high_agency: { score: 3, evidence: 'No direct evidence found in candidate submission.', rationale: 'No candidate submission available for evaluation.' },
  },
